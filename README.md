...
- **Low Detail Mode (LDM)** - Automatically enables on low-performance devices to improve frame rate by disabling particle effects and optimizing rendering. Can be manually controlled via URL parameter (?ldm) or localStorage.
